...
def renderIRslo(wf, filepre = "ir", renderGrid=False):
...
def renderOCTscans(wf, filepre = "oct", renderSeg=False):
...
if __name__ == "__main__":
    fn = "101035_L_24_1454.vol"
    vol = parseVolFile(fn)
    renderOCTscans(vol, renderSeg=True)
    renderIRslo(vol, renderGrid=True)
    saveGrid(vol, "grid.txt")
